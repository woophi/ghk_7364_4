...
export const App = () => {
  ...
  useTimeout(
    () => {
      if (steps === 'step-confirm3') {
        window.gtag('event', '7364_sms_pds_step3', { var: 'var4' });
        sendDataToGA({
          sum: pdsSum,
          product_type: 'ПДС',
        });
      ...
      if (steps === 'step4') {
        window.gtag('event', '7364_sms_deposit_step6', { var: 'var4' });
        submit();
      }
      setOtpCode('');
    },
  ...
  const goToStep2 = () => {
    window.gtag('event', '7364_open_pds_step1', { var: 'var4' });
  ...
  const goToConfirmStep3 = () => {
    window.gtag('event', '7364_pay_pds_step2', { var: 'var4' });
      ...
      <>
        ...
        <div className={appSt.bottomBtn()}>
          <Button
            ...
            view="primary"
            onClick={() => {
              window.gtag('event', '7364_pay_deposit_step5_1', { var: 'var4' });
              setSteps('step4');
            }}
          >
            Оплатить вклад
      ...
      <div style={{ backgroundColor: '#494949', minHeight: '100dvh' }}>
        ...
        <div className={appSt.bottomBtn({ confirmed: true })}>
          <Button
            ...
            view="secondary"
            onClick={() => {
              window.gtag('event', '7364_open_deposit_after_pds_step4', { var: 'var4' });
              setSteps('step3');
            }}
  ...
  return (
    <>
      <div className={appSt.container}>
        ...
        <Typography.Text view="caps">ШАГ 1 из 3</Typography.Text>
        ...
        <div className={appSt.container}>
          ...
          {faqs.map((faq, index) => (
            <div key={index}>
              <div
                onClick={() => {
                  window.gtag('event', '7364_bundle_faq', { faq: String(index + 1), var: 'var4' });
